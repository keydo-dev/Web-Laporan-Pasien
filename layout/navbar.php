        ...
        <div class="flex flex-wrap justify-between items-center ">
            <div class="flex justify-start items-center">
                ...
                <a href="/" class="flex items-center justify-between mr-4">
                    <img src="https://wuapicvisual.com/wp-content/uploads/2024/05/Contoh-Desain-Logo-Rumah-Sakit.png" class="mr-3 h-8 hidden md:inline" alt="Logo" />
                    <span class="self-center text-xl whitespace-nowrap font-bold text-green-600">Laporan <span class="text-black font-bold">Pasien.</span></span>
                </a>

                <!-- Tab Name -->
                <h4 class="hidden lg:block lg:text-2xl font-bold text-primary ml-5 text-green-600 "><?= ucwords($_GET['page']) ?></h4>
            ...
            <div class="flex items-center gap-3 lg:order-2">
                ...
                ?>
                    <a href="index.php?page=create" type="button" class="group inline-flex items-center px-4 py-2 text-sm font-medium text-green-900 bg-transparent border border-green-600 rounded green:bg-blue-600 hover:bg-green-600 hover:text-white focus:z-10 focus:ring-2 ">
                        <svg class="w-4 h-4 mr-2 text-green-900 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <?php endif ?>
                <!-- Notification icon -->
                <button type="button" data-dropdown-toggle="notification-dropdown" class="flex items-center justify-center relative w-9 h-9 rounded-xl text-gray-600 bg-green-200 hover:bg-acent1 hover:text-white focus:bg-acent1 focus:text-white transition-all duration-200">
                    <span class="absolute flex h-5 w-6 -top-2 -right-3">
                        ...
                        <span class="relative flex items-center justify-center rounded-full h-6 w-6 bg-green-600 text-[9px] text-white">02</span>
                    </span>
                ...
                <div class="hidden overflow-hidden z-50 my-4 max-w-sm text-base list-none bg-white divide-y divide-gray-100 shadow-lg dark:divide-gray-500 dark:bg-gray-100 rounded-xl" id="notification-dropdown">
                    <h4 class="block py-2 px-4 text-base font-medium text-center text-white bg-green-600">Notifications</h4>
                    <div>
                    ...
                    <a href="#" class="block py-2 text-md font-medium text-center text-white bg-green-600 hover:bg-secondary">
                ...
                <div class="hidden z-50 my-4 w-56 text-base list-none bg-white divide-y divide-gray-100 shadow dark:divide-gray-500 dark:bg-gray-100 rounded-xl" id="dropdown">
                    ...
                    <ul class="py-1 text-gray-700" aria-labelledby="dropdown">
                        <li>
                            <a href="#" class="block py-2 px-4 text-sm hover:bg-green-200">My profile</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 px-4 text-sm hover:bg-green-200">Account settings</a>
                        </li>
                    </ul>
                    <ul class="py-1 text-gray-700" aria-labelledby="dropdown">
                        <li>
                            <a href="index.php?page=logout" class="block py-2 px-4 text-sm hover:bg-green-200 rounded">Log out</a>
                        </li>
                    </ul>
                </div>
